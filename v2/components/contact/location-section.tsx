    ...
    <section className="relative overflow-hidden bg-deep-earth" aria-labelledby="v2-location-heading">
      ...
      <div className="relative z-10 mx-auto -mt-12 max-w-xl px-4 pb-12 sm:-mt-14 sm:max-w-2xl sm:pb-14 md:px-8">
        ...
        >
          ...
          <p className="mt-3 flex items-center gap-1.5 font-sans text-xs leading-relaxed text-body-brown">
            <MapPin className="size-3.5 shrink-0" />
            {REGION_LINE}
          </p>
          <p className="mt-1 flex items-center gap-1.5 font-mono text-[11px] leading-relaxed text-muted-brown/90">
