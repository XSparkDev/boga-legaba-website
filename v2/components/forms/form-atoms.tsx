...
const baseInput =
  'w-full min-w-0 rounded-xl border border-warm-sand/70 bg-off-white px-4 py-3.5 font-sans text-sm text-deep-earth placeholder:text-muted-brown/60 outline-none transition-all focus:border-terracotta focus:shadow-[0_0_0_3px_rgba(0,0,0,0.1)]'
